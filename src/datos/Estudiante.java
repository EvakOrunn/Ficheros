 ...
 */
public class Estudiante implements Grabable {
    ...
    /**
     * Constructor por defecto de la clase Alumno. Inicializa los valores del
     * legajo y las notas en -1 y el nombre en ""
     */
    public Estudiante() {
        this.legajo = -1;
        this.nombre = "";
    ...
    /**
     * Constructor de la clase Alumno, en este constructor se le solicita al
     * usuari que ingrese todos los datos del Alumno por parametro de entrada.
     *
     ...
     */
    public Estudiante(int legajo, String nombre, int notaUno, int notaDos, int notaTres) {
        this.legajo = legajo;
        this.nombre = nombre;
     ...
     *
     * @return legajo             legajo del Alumno
     */
    ...
    /**
     * Establece el legajo del Alumno teniendo en cuenta que este no puede ser
     * un valor negativo de ser asi entonces el programa lanzara una excepcion
     *
     ...
     *
     * @return nombre               nombre y apellido del Estudiante
     */
    ...
    /**
     * Establece el nombre del Estudiante teniendo en cuenta que este nombre
     * no puede superar los 60 caracteres
     * 
     * @param nombre                nombre y apellido del Estudiante
     */
    ...
    /**
     * Retorna la primera nota del Estudiante
     *
     * @return notaUno               primera del Estudiante
     */
    ...
    /**
     * Establece la primera nota del Estudiante teniendo en cuenta que esta no 
     * puede ser una nota da valor negativo 
     *
     * @param notaUno               primera nota del Estudiante
     */
